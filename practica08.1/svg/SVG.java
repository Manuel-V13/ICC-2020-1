...
public class SVG {
    ...
    /**
     * Crea una imagen SVG con el elemento lt;svg width="L" height="A" 
     *   xmlns="http://www.w3.org/2000/svg"gt;, donde L y A son las dimensiones dadas.
    ...
    public void agregarLinea(Linea linea) {
    	...
    	String v = "<line x1=\""+a+"\" y1=\""+b+ "\" x2=\""+c+"\" y2=\""+d+"\" style=\"stroke: black; stroke-width: 1; fill: none\"/>";
    	concatenar(v);
    }
     ...
     */
     public void agregarTriangulo(Triangulo triangulo) {
      ...
      Linea l2 = new Linea(triangulo.getB(), triangulo.getC());
      Linea l3 = new Linea(triangulo.getC(), triangulo.getA());
      agregarLinea(l1);
      agregarLinea(l2);
      agregarLinea(l3);
    }
    ...
    /**
     * Agrega el elemento slt;circle cx="h" cy="k" r="ra" 
     *   style="stroke: black; stroke-width: 1; fill: none" /gt; a esta imagen, donde (h, k) es el
